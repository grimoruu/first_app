...
def signup_user(payload: CreateUserSchema, db: Session = Depends(get_write_db)) -> JWTResponse:
...
def login_user(payload: LoginUserSchema, db: Session = Depends(get_read_db)) -> JWTResponse:
